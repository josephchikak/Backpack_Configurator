...
//   }
  ...
  return (
    <div className='fixed font-[black] w-[100vw] h-[20px]  z-10 bottom-[30%] right-[0] mb-5'>
        ...
        <div className='fixed top-[10%] h-[50v] font-inter '>
            <div className='w-[100vw] h-[100%] flex items-center flex-col'>
                <button className='px-4 py-2 bg-blue-400 sm:visible invisible hidden rounded-xl sm:flex gap-2 items-center' onClick={() =>   updateAR()}>
                ...
                {AR ? <div className='w-[300px] flex-col h-[40vh] relative border-blue-400 text-blue-400 border-2 mt-20 rounded-lg flex text-center p-5'>
                    <span class="material-symbols-outlined absolute top-2 right-2 cursor-pointer" onClick={() => updateAR(false)}>
                    close
                    </span>
                    <p className='p-3 border-blue-400 border-b-2 h-fit'>
                    Scan the QR code with your phone. Click on 'Enter AR' on your phone, Within 1-3 seconds the AR function opens on your phone.
                    </p>
                    <div className='flex justify-center items-center h-[100%]'>
                        <img className='h-[200px] w-auto' src="./QRcode.png" alt="qrCode" />
                    </div>
            </div> : <></>}
            </div>
