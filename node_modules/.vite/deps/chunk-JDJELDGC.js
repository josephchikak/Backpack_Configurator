...
var useIsomorphicLayoutEffect = typeof window !== "undefined" && ((_window$document = window.document) != null && _window$document.createElement || ((_window$navigator = window.navigator) == null ? void 0 : _window$navigator.product) === "ReactNative") ? import_react.default.useLayoutEffect : import_react.default.useEffect;
function tunnel() {
  ...
  return {
    In: ({
      ...
      const version2 = useStore((state) => state.version);
    ...
    Out: () => {
      ...
      return import_react.default.createElement(import_react.default.Fragment, null, current);
    }
  };
}
...
//# sourceMappingURL=chunk-JDJELDGC.js.map
