...
export declare function buildXRSessionInit(mode: XRSessionMode, domOverlayRoot: Element, { anchors, handTracking, layers, meshDetection, planeDetection, customSessionInit, depthSensing, hitTest, domOverlay, bounded, }?: XRSessionInitOptions): XRSessionInit;
