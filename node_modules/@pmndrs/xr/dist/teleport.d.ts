import { BufferGeometry, Camera, ColorRepresentation, Intersection, Mesh, Object3D, Vector3, Vector3Tuple } from 'three';
...
export declare function buildTeleportTargetFilter(options?: IntersectionOptions): (interaction: Intersection) => boolean;
